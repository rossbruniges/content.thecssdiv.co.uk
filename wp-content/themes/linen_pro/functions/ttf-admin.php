...
if ( ! class_exists('TTFCore') ) {
	class TTFCore {
		...
		<div id="v-options">
			<div id="vop-header">
				<h1><?php printf( __( '%s Options', $this->domain ), $this->themename ); ?> <img style="float: right" src="<?php echo get_template_directory_uri().'/functions/images/pro.png' ?>" alt="PRO"/></h1>
				<p><?php
					printf(
